...
export class EnquiryComponent extends MasterProvider implements OnInit {
    rateLabelLst: any;
    gstLst: any;
    loginForm: FormGroup;
    ...
    constructor(public formBuilder: FormBuilder, public router:Router, public snackBar: MatSnackBar, private spinner: NgxSpinnerService,
                public injector: Injector, public http: HttpClient, public authService: AuthService, private provider: EnquiryProvider) 
    {
