...
export class CartListDataSource extends MasterProvider implements DataSource<any> {
    
    API_LAZY_LST = "/api/quotationEnquiry/list2";
    API_LAZY_LST_COUNT = "/api/quotationEnquiry/getCount";
