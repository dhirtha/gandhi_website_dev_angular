...
@Component({
    selector: 'app-upiPaymentTest',
    templateUrl: './upiPaymentTest.component.html',
    styleUrls: ['./upiPaymentTest.component.scss']
})
export class upiPaymentTestComponent extends MasterProvider implements OnInit {
